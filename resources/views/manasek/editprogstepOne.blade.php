@include ('manasek.header')
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <p>{{trans('programm.edHagprogramms1Desc')}}</p>
                                ...
                                @else
                                   ...
                                   <select name="season" class="form-control">
									...
									<option value="{{$lkp_season->SEASON_ID}}">{{$lkp_season->SEASON_TYPE_AR}} :  {{$lkp_season->G_YEAR}}/{{$lkp_season->H_YEAR}}</option>
                                        ...
                                        <label class="errorform"> @if(count($errors) > 0) {{$errors->first('season')}}@endif</label>
                                        </div>
                                    </div>
                             <div class="form-group">
                                        <label class="col-md-3 control-label" >{{trans('programm.programName')}}<span class="errorform">*</span></label>
                                          <div class="col-md-6">
                                        <input class="form-control input-md" name="programName" placeholder="{{trans('programm.programName')}}" type="text" value="{{$oldprog->PROGRAM_NAME}}" />
                                    ...
                                    <div class="form-group">
                                       ...
                                       @foreach ($lkp_travel_methods as $lkp_travel_method)
                                        <div class="radio-inline radio-small">
                                            <label>
                                                <input class="i-radio" type="radio" value="{{$lkp_travel_method->TRAVEL_METHOD_ID}}" name="travelMethod" @if ($lkp_travel_method->TRAVEL_METHOD_ID == $oldprog->TRAVEL_METHOD_ID) checked="checked" @endif />{{$lkp_travel_method->TRAVEL_METHOD_AR}} </label>
                                        </div>
                            			@endforeach
									...
									<option value="">{{ trans('programm.programLevel') }}</option>
                                     @foreach ($lkp_program_levels as $lkp_program_level)
                                        <option value="{{ $lkp_program_level->PROGRAM_LEVEL_ID }}"  @if ($lkp_program_level->PROGRAM_LEVEL_ID == $oldprog->PROGRAM_LEVEL_ID) selected="selected"  @endif >{{ $lkp_program_level->PROGRAM_LEVEL_AR }}</option>                                                                               	@endforeach
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="radio-inline radio-small">
                                            <label>
                                                <input class="i-radio" type="radio" value="{{trans('company.yes')}}" name="containtiket" @if (trans('company.yes') == $oldprog->TICKET_FEES_INCLUDED) checked="checked" @endif  /> {{trans('company.yes')}}</label>
                                        </div>
                                        <div class="radio-inline radio-small">
                                            <label>
                                                <input class="i-radio" type="radio" value="{{trans('company.no')}}" name="containtiket" @if (trans('company.no') == $oldprog->TICKET_FEES_INCLUDED) checked="checked" @endif /> {{trans('company.no')}}</label>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="radio-inline radio-small">
                                            <label>
                                                <input class="i-radio" type="radio" value="{{trans('company.yes')}}" name="containVisa" @if (trans('company.yes') == $oldprog->VISA_FEES_INCLUDED) checked="checked" @endif  /> {{trans('company.yes')}}</label>
                                        </div>
                                        <div class="radio-inline radio-small">
                                            <label>
                                                <input class="i-radio" type="radio" value="{{trans('company.no')}}" name="containVisa" @if (trans('company.no') == $oldprog->VISA_FEES_INCLUDED) checked="checked" @endif /> {{trans('company.no')}}</label>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" >{{trans('programm.gateDiscount')}}</label>
                                          <div class="col-md-5">
                                        <input name="gateDiscount" placeholder="{{trans('programm.gateDiscount')}}"  class="form-control input-md"  type="number" value="{{$oldprog->PORTAL_PAYMENT_DISCOUNT}}" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="radio-inline radio-small">
                                            <label>
                                                <input class="i-radio" type="radio" value="{{trans('company.yes')}}" name="takseetAllowed" @if (trans('company.yes') == $oldprog->INSTALLMENT) checked="checked" @endif /> {{trans('company.yes')}}</label>
                                        </div>
                                        <div class="radio-inline radio-small">
                                            <label>
                                                <input class="i-radio" type="radio" value="{{trans('company.no')}}" name="takseetAllowed" @if (trans('company.no') == $oldprog->INSTALLMENT) checked="checked" @endif /> {{trans('company.no')}}</label>
                                        </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="radio-inline radio-small">
                                            <label>
                                                <input class="i-radio" type="radio" value="{{trans('company.yes')}}" name="ryalExchangeRate"  @if (trans('company.yes') == $oldprog->INCREASE_RYAL) checked="checked" @endif /> {{trans('company.yes')}}</label>
                                        </div>
                                        <div class="radio-inline radio-small">
                                            <label>
                                                <input class="i-radio" type="radio" value="{{trans('company.no')}}" name="ryalExchangeRate" @if (trans('company.no') == $oldprog->INCREASE_RYAL) checked="checked" @endif/> {{trans('company.no')}}</label>
                                        </div>
                                        <label class="errorform"> @if(count($errors) > 0) {{$errors->first('takseetAllowed')}}@endif</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="radio-inline radio-small">
                                            <label>
                                                <input class="i-radio" type="radio" value="{{trans('company.yes')}}" name="ticketExchangeRate"  @if (trans('company.yes') == $oldprog->INCREASE_TICKET) checked="checked" @endif /> {{trans('company.yes')}}</label>
                                        </div>
                                        <div class="radio-inline radio-small">
                                            <label>
                                                <input class="i-radio" type="radio" value="{{trans('company.no')}}" name="ticketExchangeRate" @if (trans('company.no') == $oldprog->INCREASE_TICKET) checked="checked" @endif/> {{trans('company.no')}}</label>
                                        </div>
...
var travelDate = "{{$oldprog->TRAVEL_G_DATE}}";
var returnDate = "{{$oldprog->RETURN_G_DATE}}";
